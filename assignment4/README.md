...
All the screenshots, for all the models, can be found in the folder ![alt text](https://github.com/eth-igl/gp20-alessiapacca/blob/master/assignment4/results).<br>
